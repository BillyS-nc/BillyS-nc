...
$CohUnRegisterProtectionSourceWrapper="CohUnRegisterProtectionSourceWrapperLog"

$TempPSLogfile = "$($CohUnRegisterProtectionSourceWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
#### run  ./unregisterProtectionSource.ps1 with options    #### 

./unregisterProtectionSource.ps1  -vip $CohVip -username $CohUser -domain $CohDomain  -sourceList $Dir$SourceList
