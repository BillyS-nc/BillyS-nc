...
###           ~ VERSION HISTORY ~                       ###
###     script by RMazur                                ###
###     script was updated by RMazur on 2022-10-26      ###
###########################################################
...
$CohProtGrp="SQL PROD - CL070SQLAP"
#$CohProtGrp="TEST_GRP_RM2"
$backupDate='2022-06-09'
#'2022-06-09 02:04'
$daysToKeep="12"
...
$RootCohChangeLocalRetentionWrapper="CohChangeLocalRetentionWrapperLog"

$TempPSLogfile = "$($RootCohChangeLocalRetentionWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
./changeLocalRetention.ps1 -vip $CohVip -username $CohUser -domain $CohDomain -jobName $CohProtGrp -snapshotDate $backupDate -daysToKeep $daysToKeep -force

#./changeLocalRetention.ps1 -vip $CohVip -username $CohUser -domain $CohDomain -jobName $CohProtGrp -snapshotDate $backupDate -daysToKeep $daysToKeep
