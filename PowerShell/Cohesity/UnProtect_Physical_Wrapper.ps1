...
$CohUnProtectPhysicalSourceWrapper="CohUnProtectPhysicalSourceWrapperLog"

$TempPSLogfile = "$($CohUnProtectPhysicalSourceWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
#### run  ./UnProtect_Physical.ps1 with options    #### 

./UnProtect_Physical.ps1 -vip $CohVip -username $CohUser -domain $CohDomain  -serverList $Dir$SourceList
