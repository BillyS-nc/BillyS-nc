...
#$NasSourceList="NasSources.txt"
$CohPolicy="vm_prod_45d_repl-45d"
$CohProtGrp="TEST_VM_API_ADDS"
#$NasMntPathList=
$vmList="\VM_Adds.txt"
...
$RootCohProtectVMsWrapper="CohProtectVMsWrapperLog"

$TempPSLogfile = "$($RootCohProtectVMsWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
#### run ./registerGenericNasList.ps1 with options

./protect_VMs.ps1 -vip $CohVip -username $CohUser -domain $CohDomain  -policyName $CohPolicy -jobName $CohProtGrp -timeZone 'America/New_York' -vmList $Dir$vmList
