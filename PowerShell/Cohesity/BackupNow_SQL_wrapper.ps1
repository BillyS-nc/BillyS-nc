...
#. ./cohesity-api_w-apipwd.ps1
#. ./cohesity-api.ps1

###apipwd tool to save as another user
#apipwd -vip mycluster -username myusername -domain mydomain.net -asUser  ##s-cohesity-batch -domain sigi.us.selective.com 

#Set-CohesityAPIPassword -vip sbch-dp01br.sigi.us.selective.com -username api-test  -domain LOCAL -asUser 

#-password $Password

#./backupNow.ps1 -vip sbch-dp01br.sigi.us.selective.com -username s-cohesity-batch -password $Password -domain sigi.us.selective.com -jobName 'SQL_DB_TEST_NOTLOG_API_DB380T_IT20700' -enable -keepLocalFor 45 -backupType "kRegular"
#./backupNow.ps1 -vip sbch-dp01br.sigi.us.selective.com -username api-test -password $Password -domain LOCAL -jobName 'SQL_DB_TEST_NOTLOG_API_DB380T_IT20700' -enable -keepLocalFor 45 -backupType "kRegular"
...
$CohVip="sbch-dp01br.sigi.us.selective.com" #"sbch-dp04br.sigi.us.selective.com"
$CohUser="api-test"
$CohDomain="LOCAL"
$Password='Coh351ty_t3st'
$LogDir="\PS_Script_Logs\"
$SourceList="\PhysicalSourceList.txt"
$JobName='SQL_VIEW_PROD_IT20726'
...
$CohBackupNowWrapper="CohBackupNowWrapperLog"

$TempPSLogfile = "$($CohBackupNowWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
#### 
### usage: ./backupNow.ps1 -vip mycluster -username myusername -domain mydomain.net  -jobName 'My Job' 
# -keepLocalFor 45 -backupType "kRegular"
## :: Job Run Parameters ::
...
## For Oracle databases, object names should be in the form of server.mydomain.net/dbName
##
##


./backupNow.ps1 -vip $CohVip -username $CohUser -password $Password -domain $CohDomain -jobName $JobName -backupType kFull
