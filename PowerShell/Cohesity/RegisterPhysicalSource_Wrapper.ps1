...
#### RegisterPhysicalSource_Wrapper.ps1
...
$CohRegisterPhysicalSourceWrapper="CohRegisterPhysicalSourceWrapperLog"

$TempPSLogfile = "$($CohRegisterPhysicalSourceWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
#### run  ./RegisterPhysicalSource.ps1 with options    #### 

./RegisterPhysicalSource.ps1 -vip $CohVip -username $CohUser -domain $CohDomain -serverList $Dir$SourceList
