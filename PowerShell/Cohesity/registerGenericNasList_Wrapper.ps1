...
$RootCohRegNasWrapper="CohRegNasWrapperLog"

$TempPSLogfile = "$($RootCohRegNasWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
./registerGenericNasList.ps1 -vip $CohVip -username $CohUser -domain $CohDomain  -smbUserName $SmbUser  -smbPassword $SmbPw  -nasList $Dir$NasSourceList
