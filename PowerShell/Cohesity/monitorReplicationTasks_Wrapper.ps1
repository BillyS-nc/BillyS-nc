...
#### wrapper for script monitorReplicationTasks.ps1
...
$CohMonitorReplicationTasksWrapper="CohMonitorReplicationTasksWrapperLog"

$TempPSLogfile = "$($CohMonitorReplicationTasksWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
./monitorReplicationTasks.ps1 -vip $CohVipSource -username $CohUser -domain $CohDomain -daysBack $NumDaysBack -runningOnly
