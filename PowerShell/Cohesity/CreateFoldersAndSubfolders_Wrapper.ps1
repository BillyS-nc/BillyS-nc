...
$CreateFoldersWrapper="CreateFoldersWrapperLog"

$TempPSLogfile = "$($CreateFoldersWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
####   ADD your functional SCRIPT HERE or reference additional script file with parameters ####
