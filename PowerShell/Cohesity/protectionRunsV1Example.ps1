...
[CmdletBinding()]
param (
    [Parameter()][string]$vip = 'sbch-dp01br.sigi.us.selective.com',
    [Parameter()][string]$username = 'smithb1',
    ...
    [Parameter()][string]$mfaCode = 712000,
    [Parameter()][switch]$emailMfaCode,
    [Parameter()][string]$clusterName = 'sbch-dp01br.sigi.us.selective.com',
    [Parameter()][array]$jobName,
    [Parameter()][string]$jobList,
    [Parameter()][int]$numRuns = 1,
