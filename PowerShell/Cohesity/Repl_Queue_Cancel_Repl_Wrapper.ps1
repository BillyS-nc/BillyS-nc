...
###           ~ VERSION HISTORY ~                       ###
###     script by RMazur                                ###
###     script was updated by RMazur on 2022-08-11      ###
###########################################################


#### wrapper for script ReplicationQueue_Cancel_Repl.ps1
...
$CohVipSource="sbch-dp03br.sigi.us.selective.com"
$CohVipDestination="sbch-dp01br"
$CohUser="admin" #"api-test"
$CohDomain="LOCAL"
$LogDir="\PS_Script_Logs\"
$NumDaysBack="200"
$ProtectionGroup=" "
$ProtGrpList="$PWDir\ProtrGrpList.txt"
...
$CohRepl_Queue_Cancel_Repl_Wrapper="CohRepl_Queue_Cancel_Repl_WrapperLog"

$TempPSLogfile = "$($CohRepl_Queue_Cancel_Repl_sWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
######### 
### usage:  ./replicationQueue.ps1 -vip mycluster -username myusername -domain mydomain.net
...
./ReplicationQueue_Cancel_Repl.ps1 -vip $CohVipSource -username $CohUser -domain $CohDomain -jobList $ProtGrpList -cancelAll
