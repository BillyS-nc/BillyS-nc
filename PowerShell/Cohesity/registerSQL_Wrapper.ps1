...
$CohRegisterSQLWrapper="CohRegisterSQLWrapperLog"

$TempPSLogfile = "$($CohRegisterSQLWrapper)_$(Get-Date -Format "yyyy-MM-dd_HH.mm.ss").txt"
...
./registerSQL.ps1 -vip $CohVip -username $CohUser -domain $CohDomain  -serverList $Dir$SourceList
